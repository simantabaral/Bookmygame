...
//   -->
            ...
            <nav>
                <ul>
                    <li class="reserve"><span style="cursor:pointer;" onclick="openNav()"> My Reservations</span></li></li>
                    ...
                    <tr>
                        ...
                        <td  align = "center">
                            <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status1 == "Booked") echo ' available2'; ?>"type="submit" id="6-7"><?php echo"$status1";?></button>
                            </form>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status2 == "Booked") echo ' available2'; ?>"type="submit" id="7-8"><?php echo"$status2";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status3 == "Booked") echo ' available2'; ?>"type="submit" id="8-9" value="8:00-9:00"><?php echo"$status3";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status4 == "Booked") echo ' available2'; ?>"type="submit" id="9-10" value="9:00-10:00"><?php echo"$status4";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status5 == "Booked") echo ' available2'; ?>"type="submit" id="10-11" value="10:00-11:00"><?php echo"$status5";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status6 == "Booked") echo ' available2'; ?>"type="submit" id="11-12" value="11:00-12:00"><?php echo"$status6";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status7 == "Booked") echo ' available2'; ?>"type="submit" id="12-1" value="12:00-1:00"><?php echo"$status7";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status8 == "Booked") echo ' available2'; ?>"type="submit" id="1-2" value="1:00-2:00"><?php echo"$status8";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status9 == "Booked") echo ' available2'; ?>"type="submit" id="2-3" value="2:00-3:00"><?php echo"$status9";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status10 == "Booked") echo ' available2'; ?>"type="submit" id="3-4" value="3:00-4:00"><?php echo"$status10";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <form onsubmit = "return display()" method="post" action="book.php">
                                ...
                                <button class="available<?php if ($status11 == "Booked") echo ' available2'; ?>"type="submit" id="4-5" value="4:00-5:00"><?php echo"$status11";?></button>
                            </form>                            
                        </td>
                    </tr>
                    <tr>
                        <td>5:00 - 6:00 PM</td>
                        <td align = "center">
                        <form onsubmit = "return display()" ethod="post" action="book.php">
                                <input type="hidden" name="bookingTime" value="5:00-6:00" >
                                <button class="available<?php if ($status12 == "Booked") echo ' available2'; ?>"type="submit" id="5-6" value="5:00-6:00"><?php echo"$status12";?></button>
                            </form>                            
                        </td>
                    </tr>
                    </table>
